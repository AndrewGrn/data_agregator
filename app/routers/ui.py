...
def _telegram_target_config(
    ...
    gapfill_comments_enabled: bool = False,
        ...
        if raw_edit_target_id.isdigit():
            ...
            if candidate and candidate.parser_type == parser_type:
                ...
                edit_target_config = {
                    ...
                    "gapfill_comments_enabled": bool(cfg.get("gapfill_comments_enabled", False)),
...
def create_module_target(
    ...
    thread_reparse_interval_minutes: int = Form(60),
    max_threads_per_cycle: int = Form(30),
    max_pages_per_thread: int = Form(1),
    max_posts_per_thread: int = Form(500),
    ...
    if parser_type == ParserType.telegram:
        ...
        config = {
            ...
            "max_threads_per_cycle": max(int(max_threads_per_cycle), 1),
            "max_pages_per_thread": max(int(max_pages_per_thread), 1),
            "max_posts_per_thread": max(int(max_posts_per_thread), 1),
