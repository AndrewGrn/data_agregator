...
_ALIASES: dict[str, str] = {
    # "xenforo" is the slug already stored in existing targets.config rows
    # (and possibly queued job payloads) from before adapters were renamed
    # to the consistent "*_like" convention; keep it mapped so those rows
    # keep resolving instead of silently breaking.
